...
***** Some notes that are important to use when creating segments:
-------------------------------------------------------------------
...
+ "Other" words that the user will use, must be in the train_sentences
    (not in the segments). For example, words such as ( "and", "or", "than")
    must be used otherwise NN makes mistakes such as changing "or" to "orange"
...
because "dolkar" is neither a number nor a unit
...
train_sentences = (
    ...
    " <range1><>   <units_price_$><> <price><>  <other><and>  <price><> <other><> ",
    " <other><> <range1><>   <units_price_$><> <price><> <other><and> <price><>  <other><>",
    " <range1><>  <price><>  <units_price_$><>  <other><and> <price><>  ",
    " <other><> <range1><>  <price><>  <units_price_$><>  <other><and> <price><>  ",
    " <range1><>  <price><>  <units_price_$><>  <other><and> <price><>  <other><>",
    " <other><> <range1><>  <price><>  <units_price_$><>  <other><and> <price><>  <other><>",
    ...
    " <range1><>   <units_mileage_mi><> <mileage><>  <other><and>  <mileage><> <other><> ",
    " <other><> <range1><>   <units_mileage_mi><> <mileage><> <other><and> <mileage><>  <other><>",
    " <range1><>  <mileage><>  <units_mileage_mi><>  <other><and> <mileage><>  ",
    " <other><> <range1><>  <mileage><>  <units_mileage_mi><>  <other><and> <mileage><>  ",
    " <range1><>  <mileage><>  <units_mileage_mi><>  <other><and> <mileage><>  <other><>",
    " <other><> <range1><>  <mileage><>  <units_mileage_mi><>  <other><and> <mileage><>  <other><>",
    ...
    " <range1><>  <mileage><>  <other><and> <mileage><>   <units_mileage_mi><> <other><>",
    "<other><> <range1><>  <mileage><> <other><and>  <mileage><>   <units_mileage_mi><> <other><>",
    " <range1><>    <other><year>  <year><>  <other><and> <year><>  ",
    "  <other><> <range1><>    <other><year>  <year><>  <other><and> <year><>  ",
    " <range1><>    <other><year>  <year><>  <other><and> <year><>  <other><>  ",
    "  <other><> <range1><>    <other><year>  <year><>  <other><and> <year><>   <other><> ",
    " <range1><>  <year><>   <other><year>   <other><and> <year><>  ",
    "  <other><> <range1><>  <year><>   <other><year>  <other><and>  <year><>  ",
    " <range1><>  <year><>   <other><year>  <other><and>  <year><>   <other><> ",
    "  <other><> <range1><>  <year><>   <other><year>   <other><and> <year><>   <other><> ",
    " <range1><>  <year><>  <other><and> <year><>    <other><year>  ",
    "  <other><> <range1><>  <year><>  <other><and> <year><>    <other><year>  ",
    " <range1><>  <year><>  <other><and> <year><>    <other><year>  <other><>  ",
    "  <other><> <range1><>  <year><>  <other><and> <year><>    <other><year>   <other><> ",
    "<remove><> <brand><>  <other><and>  <model><>  <other><and>  <color><> ",
    "<remove><> <units_price_$><> <price><>  <other><and> <units_mileage_mi><> <mileage><>  <other><and> <year><> ",
    "<restore><>  <setting><> <remove><>  <color><>  <other><and>  <year><> ",
    "<restore><>  <setting><> <remove><>  <brand><>   <other><and> <year><> ",
    ...
    "  <units_price_$><>  <price><>  <other><>  <other><or>  <less><> ",
    "  <other><>  <units_price_$><>  <price><>  <other><or>  <less><> ",
    ...
    "  <price><>   <units_price_$><> <other><>  <other><or> <less><> ",
    "  <other><>  <price><>   <units_price_$><> <other><or> <less><> ",
    "  <price><>   <units_price_$><> <other><or> <less><>  <other><> ",
    "  <other><>  <price><>   <units_price_$><> <other><or> <less><>  <other><> ",
    ...
    "  <year><>    <other><year>  <other><or>  <less><> ",
    "  <other><>  <year><>    <other><year>   <other><or> <less><> ",
    "  <year><>    <other><year>   <other><or> <less><>  <other><> ",
    "   <other><> <year><>    <other><year>   <other><or> <less><>  <other><> ",
    "   <other><year>  <year><>    <other><or>   <less><> ",
    "   <other><>  <other><year>  <year><>    <other><or>   <less><> ",
    "   <other><year>  <year><>    <other><or>   <less><>  <other><> ",
    "   <other><>  <other><year>  <year><>    <other><or>   <less><>  <other><> ",
    ...
    "  <mileage><>   <units_mileage_mi><> <other><>  <other><or> <less><> ",
    "  <other><>  <mileage><>   <units_mileage_mi><> <other><or> <less><> ",
    "  <mileage><>   <units_mileage_mi><> <other><or> <less><>  <other><> ",
    "  <other><>  <mileage><>   <units_mileage_mi><> <other><or> <less><>  <other><> ",
    ...
    "  <units_price_$><>  <price><>  <other><>   <other><or> <more><> ",
    "  <other><>  <units_price_$><>  <price><>  <other><or>  <more><> ",
    "  <units_price_$><>  <price><>  <other><or>  <more><>  <other><> ",
    "   <other><> <units_price_$><>  <price><>  <other><or>  <more><>  <other><> ",
    ...
    "  <year><>    <other><year>  <other><or>  <more><> ",
    "  <other><>  <year><>    <other><year>  <other><or>  <more><> ",
    "  <year><>    <other><year>  <other><or>  <more><>  <other><> ",
    "   <other><> <year><>    <other><year>  <other><or>  <more><>  <other><> ",
    "   <other><year>  <year><>    <other><or>   <more><> ",
    "   <other><>  <other><year>  <year><>    <other><or>   <more><> ",
    "   <other><year>  <year><>    <other><or>   <more><>  <other><> ",
    "   <other><>  <other><year>  <year><>    <other><or>   <more><>  <other><> ",
...
val_sentences = (
    ...
    " <other><___entWrdLblOther>  <other><>  <other><___entWrdLblOther>  <other><>  <price><> <units_price_$><> <color><>   <other><___entWrdLblOther>   <brand><> ",
...
test_sentences = (
    ...
    "<other><>  <other><>  <other><>   <other><>   <color><>  <other><> <brand><> ",
...
price_segments = (
    ...
    " <less><> <other><>  <units_price_$><> <price><>  ",
    "  <other><> <less><> <other><>  <units_price_$><> <price><>  ",
    " <less><> <other><>  <units_price_$><> <price><>   <other><> ",
    "  <other><> <less><> <other><>  <units_price_$><> <price><>  <other><>  ",
    " <less><>  <price><>   <units_price_$><> ",
    "  <other><> <less><>  <price><>   <units_price_$><> ",
    " <less><>  <price><>   <units_price_$><>  <other><> ",
    "  <other><> <less><>  <price><>   <units_price_$><>  <other><> ",
    " <less><>  <other><>   <price><>   <units_price_$><> ",
    "  <other><> <less><>  <other><>   <price><>   <units_price_$><> ",
    " <less><>  <other><>   <price><>   <units_price_$><>  <other><> ",
    "  <other><> <less><>  <other><>   <price><>   <units_price_$><>  <other><> ",
    ...
    " <more><> <other><>  <units_price_$><> <price><>  ",
    "  <other><> <more><> <other><>  <units_price_$><> <price><>  ",
    " <more><> <other><>  <units_price_$><> <price><>   <other><> ",
    "  <other><> <more><> <other><>  <units_price_$><> <price><>  <other><>  ",
    " <more><>  <price><>   <units_price_$><> ",
    "  <other><> <more><>  <price><>   <units_price_$><> ",
    " <more><>  <price><>   <units_price_$><>  <other><> ",
    "  <other><> <more><>  <price><>   <units_price_$><>  <other><> ",
    " <more><>  <other><>   <price><>   <units_price_$><> ",
    "  <other><> <more><>  <other><>   <price><>   <units_price_$><> ",
    " <more><>  <other><>   <price><>   <units_price_$><>  <other><> ",
    "  <other><> <more><>  <other><>   <price><>   <units_price_$><>  <other><> ",
...
mileage_segments = (
    ...
    " <less><> <other><>  <units_mileage_mi><> <mileage><>  ",
    "  <other><> <less><> <other><>  <units_mileage_mi><> <mileage><>  ",
    " <less><> <other><>  <units_mileage_mi><> <mileage><>   <other><> ",
    "  <other><> <less><> <other><>  <units_mileage_mi><> <mileage><>  <other><>  ",
    ...
    " <less><>  <other><>   <mileage><>   <units_mileage_mi><> ",
    "  <other><> <less><>  <other><>   <mileage><>   <units_mileage_mi><> ",
    " <less><>  <other><>   <mileage><>   <units_mileage_mi><>  <other><> ",
    "  <other><> <less><>  <other><>   <mileage><>   <units_mileage_mi><>  <other><> ",
    ...
    " <more><> <other><>  <units_mileage_mi><> <mileage><>  ",
    "  <other><> <more><> <other><>  <units_mileage_mi><> <mileage><>  ",
    " <more><> <other><>  <units_mileage_mi><> <mileage><>   <other><> ",
    "  <other><> <more><> <other><>  <units_mileage_mi><> <mileage><>  <other><>  ",
    ...
    " <more><>  <other><>   <mileage><>   <units_mileage_mi><> ",
    "  <other><> <more><>  <other><>   <mileage><>   <units_mileage_mi><> ",
    " <more><>  <other><>   <mileage><>   <units_mileage_mi><>  <other><> ",
    "  <other><> <more><>  <other><>   <mileage><>   <units_mileage_mi><>  <other><> ",
...
year_segments = (
    ...
    " <less><>  <other><>    <other><year>  <year><>  ",
    "  <other><> <less><>  <other><>    <other><year>  <year><>  ",
    " <less><>  <other><>    <other><year>  <year><>   <other><> ",
    "  <other><> <less><>  <other><>    <other><year>  <year><>   <other><> ",
    ...
    " <more><>  <other><>    <other><year>  <year><>  ",
    "  <other><> <more><>  <other><>    <other><year>  <year><>  ",
    " <more><>  <other><>    <other><year>  <year><>   <other><> ",
    "  <other><> <more><>  <other><>    <other><year>  <year><>   <other><> ",
...
mixed_segments = (
    ...
    " <model><>  <year><> <range2><> <year><>   <color><>    <less><>  <other><>   <price><> <units_price_$><>  <less><>  <other><>  <mileage><>   <units_mileage_mi><> ",
    " <color><>  <more><>   <other><>  <year><>  <model><> <brand><>   <units_price_$><> <price><>   <range2><-> <price><>  <mileage><>   <range2><->  <units_mileage_mi><> <mileage><>  ",
    ...
    "  <year><> <range2><> <year><>   <color><>    <less><>  <other><>   <units_price_$><> <price><> <model><>   <less><>  <other><>   <mileage><>   <units_mileage_mi><> ",
    ...
    " <other><>  <TBD><___multilabel>  <other><___entWrdLblOther>   <brand><>   <other><___entWrdLblOther>  <model><>  <other><>   <other><___entWrdLblOther>   <other><> <less><>   <other><>  <units_price_$><> <price><>",
    "  <TBD><___multilabel> <other><>  <TBD><___assoc_brand_modelNum> <other><___entWrdLblOther>   <other><>  <model><>   <other><___entWrdLblOther>  <brand><>  <other><___entWrdLblOther>   <color><>  <other><>   <mileage><>   <units_mileage_mi><> ",
    ...
    "<color><>  <other><>  <price><___rdmYear> <range2><> <price><___rdmYear> <units_price_$><>   <less><>  <other><>  <mileage><___rdmYear> <units_mileage_mi><> ",
    " <mileage><___rdmYear> <units_mileage_mi><>   <price><___rdmYear> <units_price_$><> ",
    "  <other><> <units_price_$><> <price><___rdmYear> <more><> <mileage><___rdmYear> <units_mileage_mi><>",
...
# entityWrds_withLbl_other is not used because it confuses Bert
